...
static void getCoordinatesTest() {
	...
	static_assert(FindVehicle<list2x3, X, 3>::row == 1, "Fail");
	static_assert(FindVehicle<list2x3, X, 3>::col == 0, "Fail");

	static_assert(FindVehicle<list2x3, A, 3>::row == 1, "Fail");
	static_assert(FindVehicle<list2x3, X, 3>::col == 1, "Fail");

	static_assert(FindVehicle<list2x3, A, 3>::row == 1, "Fail");
	static_assert(FindVehicle<list2x3, A, 3>::col == 1, "Fail");
}
